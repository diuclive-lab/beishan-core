#!/usr/bin/env python3
import json, sys
SKILL_DEF={"name":"ai_frontier","description":"最新进展、论文解读、技术趋势","tools":[{"name":"track_ai","description":"最新进展、论文解读、技术趋势","inputSchema":{"type":"object","properties":{"topic": {"type": "string", "description": "topic"}},"required":["topic"]}}]}
HANDLERS={}
