#!/usr/bin/env python3
import json, sys
SKILL_DEF={"name":"legal_research","description":"法律法规检索、案例分析、合规评估","tools":[{"name":"legal_analysis","description":"法律法规检索、案例分析、合规评估","inputSchema":{"type":"object","properties":{"question": {"type": "string", "description": "question"}},"required":["question"]}}]}
HANDLERS={}
def tool(f): HANDLERS[f.__name__]=f; return f

@tool
def legal_analysis(args):
