#!/usr/bin/env python3
import json, sys
SKILL_DEF={"name":"domain_synthesis","description":"跨学科知识整合、多维度分析","tools":[{"name":"synthesize","description":"跨学科知识整合、多维度分析","inputSchema":{"type":"object","properties":{"question": {"type": "string", "description": "question"}},"required":["question"]}}]}
HANDLERS={}
