#!/usr/bin/env python3
import json, sys
SKILL_DEF={"name":"idle_inspection","description":"系统健康检查、异常检测","tools":[{"name":"inspect","description":"系统健康检查、异常检测","inputSchema":{"type":"object","properties":{"scope": {"type": "string", "description": "scope"}},"required":["scope"]}}]}
HANDLERS={}
