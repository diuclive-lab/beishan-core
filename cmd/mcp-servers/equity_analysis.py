#!/usr/bin/env python3
import json, sys
SKILL_DEF={"name":"equity_analysis","description":"技术分析、基本面研究、投资策略","tools":[{"name":"analyze_stock","description":"技术分析、基本面研究、投资策略","inputSchema":{"type":"object","properties":{"symbol": {"type": "string", "description": "symbol"}},"required":["symbol"]}}]}
HANDLERS={}
