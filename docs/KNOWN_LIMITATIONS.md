...
会话落盘/故障切换）。下列三类曾被单列，其中第 2 类已于 2026-05-29 修复，第 1、3 类**刻意未覆盖**：
...
**影响**：第 2 类已修复后，仅剩第 1、3 类 goroutine 内若发生未预期 panic（概率极低）仍可能终止进程。

**缓解**：第 1、3 类风险极低（跑的全是不 panic 的 stdlib）；第 2 类已于 2026-05-29 在
