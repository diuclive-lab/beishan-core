...
> (4) code_security 8 rules (dangerous_rm_rf, path_traversal, sensitive_path_write, dangerous_permissions, self_modification, command_injection, unsafe_write_path, hardcoded_secret — SQL injection is NOT guaranteed), 
