	...
	return []RouteRule{
		{
			...
			Prefixes:  []string{"看桌面", "看屏幕"},
			Keywords:  []string{"截屏", "截图", "屏幕上"},
			Negatives: []string{"文件", "目录", "md", "有哪些", "项目", "代码"},
			Threshold: 0.3,
			Priority:  2,
		},
		{
			...
			Keywords:  []string{"桌面文件", "桌面目录", "桌面上", "桌面上都有", "桌面上.*文件"},
			Negatives: []string{"屏幕", "截图", "窗口", "看"},
			Threshold: 0.3,
			Priority:  1,
		},
		{
