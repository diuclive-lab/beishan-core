...
- OpenHuman (github.com/tinyhumansai/openhuman) — Rust Tauri 应用，RPC 调度 + Socket.IO 事件架构。
  L2 通信层参考见 docs/reports/openhuman_rightflower_integration_record.md 附录 B。
